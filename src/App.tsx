    ...
    <div className="mt-8 bg-white/5 p-6 rounded-2xl border border-white/6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-300 text-sm">Cadastre seu e-mail e receba novidades e descontos exclusivos.</p>
        </div>

        <form
          onSubmit={(e) => {
            e.preventDefault();
            // handle submit (integrate with your backend / email provider)
        ...
        >
          <input
            ...
            required
            className="px-4 py-2 rounded-md bg-transparent border border-white/8 focus:outline-none"
          />
          <Button type="submit">
            <span className="px-4 py-2">Inscrever</span>
          </Button>
        </form>
      </div>
    </div>
    ...
    <footer className="mt-16 border-t border-white/6 bg-transparent">
      <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row justify-between items-start gap-6">
        <div className="flex flex-col gap-3">
          <img src="/images/logo.png" alt="LMG Tech" className="w-40 object-contain" />
          <p className="text-slate-300 text-sm max-w-sm">
            LMG Tech — soluções e acessórios eletrônicos com design e performance. Atendimento e garantia inclusos.
          </p>
        </div>
